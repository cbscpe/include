...
;	adc		zh, zh
	lpm		r24, Z+
	lpm		r25, Z+					; Get address of syntax element
	cp		r24, zero
	cpc		r25, zero
	breq	scancommandfailed		; End of Table
	push	xl
	push	xh						; Remember pointer into buffer
	push	zl
	push	zh						; Save table pointer
	add		r24, r24
...
scancommanddone:
	movw	zh:zl, r25:r24			
;	call	print
;	.db		"Valid Command. ", 0x0a, 0x0d, 0x00
	clc
	ret
;
;	Skip blanks
