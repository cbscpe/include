...
;
;
;	2021-12-05	Using r25:r24 already matches ABI, however the use of
;			carry to signal out of memory is not conform to the ABI
;			therefore we also set r25:r24 = 0 if no memory could
;			be allocated, i.e. return NULL if failed
;	Input:
...
freedebug:
	...
	sts	pprint+5, zh
	call	print
	.db	"free0", 0x86," X: 0x", 0x81, 0x80, ", Y: 0x", 0x83, 0x82, ", Z: 0x", \
		0x85, 0x84, 0x0d, 0x0a, 0x00, 0x00
	ret
#endif
free:
	push	r16
