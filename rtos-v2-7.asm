...
;
;	2024-01-09	PS	Make changes to how create_: generates the data
...
rtos_:
	...
	lds	yl, curjob+0		; Do this here for all OS Calls
	sts	tesoutent+1, yl
	ret
#else
	sbic	b_RTOS			; Is it an OSCALL software interrupt
...
create_:	
	...
	sts	tesoutent+1, r24	; Job ID of new Job = Low byte of JCB Address
...
;
	st	-X, r23			; New: the start parameter of the job
	st	-X, r22			; created is passed as the second paremeter
