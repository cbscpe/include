...
;					#define charout
;					#define charin
;		2021-06-11	Test Monitor, we need to find the issues with this
;					piece of code and make a new version that no longer
;					is a one-to-one translation of the Apple II monitor
;==========================================================================
	.dseg
prompt:		.byte	1
mode:		.byte	1
